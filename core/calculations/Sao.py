...
"""
from core.calculations.AmDuong import nguHanh
...
saoLuuLocTonDaiVan = Sao(110, "Lộc tồn.ĐV", "O", 3, "Lưu tinh")
saoLuuLocTonTieuVan = Sao(111, "Lộc tồn.TV", "O", 3, "Lưu tinh")
saoLuuKinhDuongDaiVan = Sao(112, "Kình dương.ĐV", "K", 11, "Lưu tinh")
saoLuuDaLaDaiVan = Sao(113, "Đà la.ĐV", "K", 11, "Lưu tinh")
saoLuuKinhDuongTieuVan = Sao(114, "Kình dương.TV", "K", 11, "Lưu tinh")
saoLuuDaLaTieuVan = Sao(115, "Đà la.TV", "K", 11, "Lưu tinh")

# Tứ Hóa Lưu Đại Vận
saoLuuHoaLocDaiVan = Sao(116, "Hóa lộc.ĐV", "M", 3, "Lưu tinh")
saoLuuHoaQuyenDaiVan = Sao(117, "Hóa quyền.ĐV", "M", 4, "Lưu tinh")
saoLuuHoaKhoaDaiVan = Sao(118, "Hóa khoa.ĐV", "M", 5, "Lưu tinh")
saoLuuHoaKyDaiVan = Sao(119, "Hóa kỵ.ĐV", "T", 13, "Lưu tinh")

# Tứ Hóa Lưu Tiểu Vận
saoLuuHoaLocTieuVan = Sao(120, "Hóa lộc.TV", "M", 3, "Lưu tinh")
saoLuuHoaQuyenTieuVan = Sao(121, "Hóa quyền.TV", "M", 4, "Lưu tinh")
saoLuuHoaKhoaTieuVan = Sao(122, "Hóa khoa.TV", "M", 5, "Lưu tinh")
saoLuuHoaKyTieuVan = Sao(123, "Hóa kỵ.TV", "T", 13, "Lưu tinh")

# Tứ Hóa Lưu Tháng
saoLuuHoaLocThang = Sao(124, "Hóa lộc.Th", "M", 3, "Lưu tinh")
saoLuuHoaQuyenThang = Sao(125, "Hóa quyền.Th", "M", 4, "Lưu tinh")
saoLuuHoaKhoaThang = Sao(126, "Hóa khoa.Th", "M", 5, "Lưu tinh")
saoLuuHoaKyThang = Sao(127, "Hóa kỵ.Th", "T", 13, "Lưu tinh")

# Tứ Hóa Lưu Ngày
saoLuuHoaLocNgay = Sao(128, "Hóa lộc.Ng", "M", 3, "Lưu tinh")
...
# Vòng Tràng sinh
saoTrangSinh = Sao(39, "Trường Sinh", "T", 5, vongTrangSinh=1)
...
saoHoaKhoa = Sao(92, "Hóa khoa", "M", 5)
saoHoaQuyen = Sao(93, "Hóa quyền", "M", 4)
